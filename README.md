...
## 3: Запуск двух контейнеров с `aafire`
## 4: Создание сети `myNetwork`
## 5: Подключение контейнеров к сети `myNetwork`
## 6: Проверка соединения между контейнерами с помощью `ping`
